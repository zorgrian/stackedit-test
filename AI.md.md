...
Artificial Intelligence — or AI — is computer **software** that can learn, reason, and **act like humans**. It does not think as we do, but it mimics human behaviour using patterns in data. Modern AI includes chatbots, image generators, and recommendation systems you use every day.
...
***
Arguably, the first AI to hit the headlines, and become popular, was ChatGPT. Unfortunately, the em-dash became associated with ChatGPT. In some circles, the em-dash — itself — is known as the ChatGPT dash. Although inaccurate,  Wikipedia will 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM2OTYxNzU2XX0=
-->